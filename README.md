...
| 2   | User mendaftar akun dengan input valid                                                                            | User mengakses WareWareHouse | User mengakses laman sign-up melalui link yang tersedia pada laman login lalu mengisi data yang diperlukan | Pendaftaran Berhasil                   | Pendaftaran Berhasil | As expected | Pass ✔ |
